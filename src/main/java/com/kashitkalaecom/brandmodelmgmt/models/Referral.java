...
public class Referral {
	...
	public String getDiscountForSender() {
		return discountForSender;
	}
	public void setDiscountForSender(String discountForSender) {
		this.discountForSender = discountForSender;
	}
